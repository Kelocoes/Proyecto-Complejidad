...
def main():
    ...
    window = sg.Window('Form Fill Demonstration', layout, size=(600, 550), grab_anywhere=False, element_justification='c')
    ...
    while True:
        ...
        if event == 'SaveSettings':
            ...
            if len(ciudadesCoordenadas) > 0:
                posX, posY = mapi.linkZinc(int(n), len(ciudadesCoordenadas), ciudadesCoordenadas)
                print(posX,posY)
